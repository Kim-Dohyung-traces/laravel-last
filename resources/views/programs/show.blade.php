<div class="show-form{{$program->id}} showbox">
    ...
    <div class="show-body col-md-11">
        <div class="show-imgbox col-md-8">
            <img class="show-img" src="http://127.0.0.1:8000/files3/{{\App\Program_attachment::whereId($program->id)->first()->filename}}" alt="program-img">
        </div>
        <hr>
